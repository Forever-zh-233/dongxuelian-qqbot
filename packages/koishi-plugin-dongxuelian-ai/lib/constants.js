...
const THROTTLE_CONFIG_FILE = path.join(DATA_DIR, 'ai-throttle-config.json')
...
const OVERUSED_REPLY_PATTERNS = [/你妈的话你信不信我帮你转达/, /你照镜子说的/, /先看看自己/, /你他妈脑子进水了/, /词汇量也就够在键盘上撒泼/, /连骂人都得靠复读/, /废物也配骂人/, /只会喷粪的嘴/, /现实里怕是连条/, /你这种货色也就配在/, /连条野狗都/, /连条母狗都/, /废物也配(?:要|伸手)/, /也配.*证明/, /先去把.{2,20}(?:搞|弄|搞搞)明白/, /先去把.{2,20}吃透/, /再出来丢人/, /再出来装/, /啃明白再/, /^哼[，,。！ ]/]
...
module.exports = {
  ...
  RANDOM_WHITELIST_FILE, RANDOM_RATE_FILE, THROTTLE_CONFIG_FILE, ADMIN_IDS_FILE,
